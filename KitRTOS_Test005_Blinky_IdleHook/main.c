...
/*
 *  The use of blocking vTaskDelay() API calls in Test003
 *  created a lot of idle time—time when the Idle task is executing
 *  because both application tasks are in the Blocked state. This
 *  example makes use of this idle time through the addition of an
 *  Idle hook function.
 *
 */
