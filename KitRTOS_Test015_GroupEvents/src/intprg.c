...
void Excep_TMR0_CMIA0(void){
	 ...
	 * ensure the compiler does not allocate the string on the stack of the ISR, as
	 * the ISR's stack frame will not exist when the string is printed from the daemon
	 * task. */
