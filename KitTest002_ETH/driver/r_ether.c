...
*         : 19.05.2010 1.03    Modification of comment and wait counter
*         : 21.07.2010 1.04    Modification of negotiation settings
******************************************************************************/
...
static int8_t	rxbuf[ENTRY][ALIGNED_BUFSIZE];     /* receive data buffer */
#pragma section  _TX_BUFF
static int8_t	txbuf[ENTRY][ALIGNED_BUFSIZE];    /* transmit data buffer */
#pragma section
...
int32_t R_Ether_Open(uint32_t ch, uint8_t mac_addr[])
{
  ...
  if (phydata & PHY_AN_LINK_PARTNER_FULL)
  {
	...
	if ((phydata & PHY_AN_LINK_PARTNER_100FULL) == PHY_AN_LINK_PARTNER_100FULL)
	{
		/* Full duplex */
		ETHERC.ECMR.BIT.DM = 1;
		/* 100Mbps */
	...
	else if ((phydata & PHY_AN_LINK_PARTNER_100HALF) == PHY_AN_LINK_PARTNER_100HALF)
	{
		/* Half duplex */
		ETHERC.ECMR.BIT.DM = 0;
		/* 100Mbps */
	...
	else if ((phydata & PHY_AN_LINK_PARTNER_10FULL) == PHY_AN_LINK_PARTNER_10FULL)
	{
		/* Full duplex */
		ETHERC.ECMR.BIT.DM = 1;
		/* 10Mbps */
	...
	else if ((phydata & PHY_AN_LINK_PARTNER_10HALF) == PHY_AN_LINK_PARTNER_10HALF)
	{
		/* Half duplex */
		ETHERC.ECMR.BIT.DM = 0;
		/* 10Mbps */
