...
/* Function prototypes */
//bool R_IO_PORT_Set(uint16_t,uint8_t);
//bool R_IO_PORT_ReadControl(uint16_t,uint8_t,uint8_t *);
//bool R_IO_PORT_ModifyControl(uint16_t,uint8_t,uint8_t);
//bool R_IO_PORT_Read(uint16_t,uint8_t *);
//bool R_IO_PORT_Write(uint16_t,uint8_t);
//bool R_IO_PORT_Compare(uint16_t,uint8_t,void *);
//bool R_IO_PORT_Modify(uint16_t,uint8_t,uint8_t);
//bool R_IO_PORT_Wait(uint16_t,uint8_t);
