...
Dec 06 2011             Updated to support CAN extended ID mode.         
******************************************************************************/
...
#define     RSK_RX62N_SW3_MASK		0x04//0b00000100  /* Switch 3 mask */
#define     RSK_RX62N_SW23_MASK		0x06//0b00000110  /* Switch 2 & 3 mask */
#define     RSK_RX62N_SW12_MASK		0x03//0b00000011  /* Switch 1 & 2 mask */
#define     RSK_RX62N_SW123_MASK 	0x07//0b00000111  /* All Switches mask */
#define     RSK_RX62N_SW_NONE		0x07//0b00000111  /* No Switch */
//#define     RSK_RX62N_SW_ALL	    0b00000000  /* All switches */
#define     RSK_RX62N_SW1	    	0x06//0b00000110  /* Switch 1 pressed only */
#define     RSK_RX62N_SW2			0x05//0b00000101  /* Switch 2 pressed only */
...
void ReadSwitches(void)
{
	...
	current_sw_pos = PORT4.PORT.BYTE & RSK_RX62N_SW123_MASK;
