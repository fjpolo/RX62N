...
*                group of LEDs on the Renesas RSK board.  On the Web page  
...
void user_app(void)
{
  if (LEDflag)
  {
    ...
    for (i = 0; i < 3; i++)
    {
      ...
      // NOTE: LED0 is used by timer tick to indicate activity
      switch(i)
  	  {
  		case 0:	
          LED1 = ledval;		// either ON or OFF
  		  break;
  		case 1:	
          LED2 = ledval;		// either ON or OFF
  		  break;
  		case 2:	
          LED3 = ledval;		// either ON or OFF
  		  break;
  		default:
  		  break;
  	  }
